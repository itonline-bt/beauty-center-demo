    ...
    <SidebarLayout>
      <div className="space-y-6 animate-fadeIn max-w-3xl">
        <PageHeader
          ...
          subtitle={
            locale === "lo"
              ? "ຕັ້ງຄ່າຂໍ້ມູນຮ້ານ ແລະ ລະບົບ"
              : "Configure shop information and system"
          }
        />
        ...
        {saved && (
          <Alert
            variant="success"
            title={locale === "lo" ? "ບັນທຶກສຳເລັດ!" : "Settings saved!"}
          >
            {locale === "lo"
              ? "ການຕັ້ງຄ່າຖືກບັນທຶກແລ້ວ"
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="font-semibold text-gray-900">
                  {locale === "lo" ? "ຂໍ້ມູນຮ້ານ" : "Shop Information"}
                </h2>
                <p className="text-sm text-gray-500">
                  {locale === "lo"
                    ? "ຕັ້ງຄ່າຊື່ ແລະ ຂໍ້ມູນຕິດຕໍ່ຮ້ານ"
                    : "Configure shop name and contact"}
                </p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, shop_name_lo: e.target.value })
                  }
                  icon={<Store className="w-5 h-5" />}
                />
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setForm({ ...form, address_lo: e.target.value })
                      }
                      className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg resize-none"
                      rows={2}
                    />
          ...
          <Card>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="font-semibold text-gray-900">
                  {locale === "lo" ? "ຕັ້ງຄ່າການເງິນ" : "Financial Settings"}
                </h2>
                <p className="text-sm text-gray-500">
                  {locale === "lo"
                    ? "ສະກຸນເງິນ, ອາກອນ ແລະ ມັດຈຳ"
                    : "Currency, tax and deposit"}
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  {locale === "lo" ? "ສະກຸນເງິນຫຼັກ" : "Base Currency"}
                </label>
                <select
                  value={form.currency}
                  onChange={(e) =>
              ...
              <Input
                label={`${
                  locale === "lo" ? "ມັດຈຳເລີ່ມຕົ້ນ" : "Default Deposit"
                } (%)`}
                type="number"
                value={String(form.deposit_percentage || 30)}
                onChange={(e) =>
                  setForm({
                    ...form,
          ...
          <Card>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-semibold text-gray-900">
                    {locale === "lo" ? "ອັດຕາແລກປ່ຽນ" : "Exchange Rates"}
                  </h2>
                  <p className="text-sm text-gray-500">
                    {locale === "lo"
                      ? "ກົດແກ້ໄຂເພື່ອປ່ຽນອັດຕາ (ອີງໃສ່ກີບ)"
                      : "Click edit to change rates (based on LAK)"}
                  </p>
                </div>
              </div>
              <Button
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            {locale === "lo" ? config.name_lo : config.name}
                          </p>
                        </div>
                      </div>
                      {!isLAK && !isEditing && (
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-purple-600 font-medium">
                          ...
                          <span className="text-lg font-bold">
                            {exchangeRates[curr].toLocaleString()}
                          </span>{" "}
                          LAK
                        </p>
                      </div>
            ...
            <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-sm text-amber-800">
                <strong>💡 {locale === "lo" ? "ໝາຍເຫດ" : "Note"}:</strong>{" "}
                {locale === "lo"
        ...
        <Card className="bg-gray-50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Version 1.2.0 • Editable Exchange Rates
              </p>
            </div>
          </div>
        </Card>
