    ...
    <SidebarLayout>
      <div className="space-y-6 animate-fadeIn max-w-3xl">
        ...
        <Card className="bg-gray-50">
          <div className="flex items-center gap-3"><Settings className="w-5 h-5 text-gray-400" /><div><p className="text-sm font-medium text-gray-700">Beauty Center Demo</p><p className="text-xs text-gray-500">Version 1.2.0 • Editable Exchange Rates</p></div></div>
        </Card>
      </div>
    </SidebarLayout>
  );
